...
class ImageViewer:
    ...
    def create_widgets(self):
        ...
        # Open button
        self.open_btn = tk.Button(control_frame, text="Open Folder", 
        ...
        # Previous button
        self.prev_btn = tk.Button(control_frame, text="◀ Previous", 
        ...
        # Next button
        self.next_btn = tk.Button(control_frame, text="Next ▶", 
    ...
    def update_info(self):
        if self.image_files:
            ...
            info_text = f"Image {self.current_index + 1} of {len(self.image_files)}: {current_file}"
