...
class ImageViewer:
    ...
    def load_images_from_folder(self):
        try:
            ...
            if self.image_files:
                ...
                messagebox.showinfo("Tidak ada Gambar", "Tidak ada file gambar yang didukung ditemukan di folder yang dipilih.")
                self.reset_display()
                
        except Exception as e:
            messagebox.showerror("Error", f"Kesalahan saat mengambil Folder: {str(e)}")
    ...
    def display_current_image(self):
        ...
        try:
            ...
            messagebox.showerror("Error", f"Kesalahan saat Mengambil Gambar: {str(e)}")
